        ...
        <>
            ...
            <section id='sobre' className='container'>
                ...
                <div className='sobre-div'>
                    <img width={"40%"} src='/imgs/ryan.jpg' />
            ...
            <section id='skills' className='container'>
                <h1>SKILLS</h1><hr />
                <div>
                    <img className='container' src="/imgs/technologies/html5.svg" />
                    <img className='container' src="/imgs/technologies/python.svg" />
                    <img className='container' src="/imgs/technologies/nodejs.svg" />
                    <img className='container' src="/imgs/technologies/react.svg" />
                    <img className='container' src="/imgs/technologies/c.svg" />
                    <img className='container' src="/imgs/technologies/cpp.svg" />
                    <img className='container' src="/imgs/technologies/php.svg" />
                    <img className='container' src="/imgs/technologies/java.svg" />
                    <img className='container' src="/imgs/technologies/spring.svg" />
                    <img className='container' src="/imgs/technologies/bootstrap.svg" />
                    <img className='container' src="/imgs/technologies/mysql.svg" />
                </div>
            </section>
            ...
            <section id='middle' preload="true">
                <div className='container'>
                    <div>
                        <h2>
                            <img width={70} src='/imgs/leaf.svg' preload="true" /><br />
            ...
            <section id='contato' className='container'>
                <h1>Contato</h1><hr/>
                <div>
                    <img width={"30%"} src='/imgs/connections.svg' />
                    <div className='container'>
                        <h3>
